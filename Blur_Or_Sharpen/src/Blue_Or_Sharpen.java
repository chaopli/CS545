...
public class Blue_Or_Sharpen implements PlugInFilter {
...
//		cv.convolve(tmpProcessor, H_x, H_x.length, 1);
//		cv.convolve(tmpProcessor, H_y, 1, H_y.length);
	...
	public void adjustmentValueChanged(AdjustmentEvent e) 
	{
		...
		if (e.getSource() == scrollBarX)
		{
			...
			String title = "sigma= "+Double.toString(sigma_x)+", sigma y= "+Double.toString(sigma_y)+", w="+Double.toString(w);
			ProcessImage();
			super.ic.repaint();
			setTitle(title);
			pack();
